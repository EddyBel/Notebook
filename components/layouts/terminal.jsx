    ...
    <div className="w-1/2 mx-auto">
      <div className="w-full shadow-2xl subpixel-antialiased rounded h-64 bg-black border-black mx-auto">
        ...
        <div
          ...
          id="console"
        >
          <p className="pb-1">Last login: Wed Sep 25 09:11:04 on levil190</p>
          <p className="pb-1">
            Laraben:Devprojects levin$
            <input
              type="text"
              className="bg-black text-blue-600 focus:border-0 focus:outline-0 ml-1"
              autoFocus
            />
          </p>
        </div>
